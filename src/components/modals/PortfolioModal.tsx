...
const PROJECTS: Project[] = [
  ...
  },
  {
    id: 'mir-lumi',
    title: '«Мир Луми»',
    category: 'Интерактивный продукт • Game Design • AI',
    year: '2026',
    description: '«Мир Луми» — интерактивная развивающая игровая среда для детей. Проект объединяет персонажа Луми, игровые задания, визуальную систему и постепенное усложнение механик. Игры созданы так, чтобы ребёнок не просто выполнял задания, а учился замечать, запоминать, сравнивать, действовать по правилу и постепенно становиться самостоятельнее.',
    role: 'Автор концепции и игровой логики, разработка сценариев и механик, создание персонажа и визуальной системы с использованием ИИ, UX/UI-дизайн, прототипирование и разработка интерактивного веб-приложения в Google AI Studio, публикация проекта.',
    tags: [
      'Game Design',
      'Educational Game',
      'AI Product',
    ...
    metrics: 'Интерактивный продукт • AI • Game Design',
    client: 'Авторский проект',
    linkUrl: 'https://savinaekaterina.github.io/mirlumi/',
